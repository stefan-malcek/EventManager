...
namespace EventManager.PL.Helpers
{
    ...
    {
        private readonly AuthenticationWrapper mAuthenticationWrapper;
        ...
        {
            this.mAuthenticationWrapper = authWrapper;

            this.mAuthenticationWrapper.InitializeIssueTokenAction(issueTokenAction);
            this.mAuthenticationWrapper.InitializeRevokeTokenAction(revokeTokenAction);
        }

        public void SignIn(Guid userId, bool rememberMe)
        {
            mAuthenticationWrapper.PerformSignIn(userId, rememberMe);
        }

        public void SignOut()
        {
            mAuthenticationWrapper.PerformSignOut();
        }
    }
}